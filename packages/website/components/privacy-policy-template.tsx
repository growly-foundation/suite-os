...
export default function PrivacyPolicyTemplate({
  ...
  return (
    <div className="prose prose-blue max-w-none dark:prose-invert">
      ...
      <p>
        At {companyName}, we take your privacy seriously. This Privacy Policy explains how we
        collect, use, disclose, and safeguard your information when you visit our website{' '}
        {websiteUrl} and use our services. Please read this privacy policy carefully. If you do not
        agree with the terms of this privacy policy, please do not access our website or use our
        services.
      </p>
      ...
      <p>
        ...
        create or modify your profile, set preferences, sign-up for or make purchases through our
      ...
      <p>
        ...
        your personal information. However, please be aware that no security measures are perfect or
        impenetrable, and we cannot guarantee the security of your data transmitted to our services.
      </p>
      <p>
        Your data is stored on secure servers and we maintain strict access controls to protect your
        information. We use industry-standard encryption for data in transit and at rest.
      </p>

      <h2>Data Retention</h2>
      <p>
        We retain personal information for as long as necessary to fulfill the purposes outlined in
        this privacy policy, unless a longer retention period is required or permitted by law. We
      ...
      <ul>
        ...
        <li>
          <strong>Legal Requirements:</strong> We may disclose your information where required to do
      ...
      {includeAnalytics && (
        <>
          ...
          <p>
            ...
            These services help us understand how users interact with our services, which pages are
            visited most often, and how users navigate through our website. This information is used
      ...
      {includeGDPR && (
        <>
          ...
          <p>
            ...
            protection rights under the General Data Protection Regulation (GDPR). We aim to take
          ...
          <ul>
            ...
            <li>
              The right of rectification - the right to have your information corrected if it is
              inaccurate or incomplete
            </li>
            <li>The right to object to our processing of your Personal Information</li>
            <li>
              The right of restriction - the right to request that we restrict the processing of
              your personal information
            </li>
            <li>
              The right to data portability - the right to be provided with a copy of your Personal
              Information in a structured, machine-readable and commonly used format
            </li>
            <li>
              The right to withdraw consent at any time where we relied on your consent to process
              your personal information
            </li>
          </ul>
          <p>
      ...
      {includeCCPA && (
        <>
          ...
          <p>
            ...
            information under the California Consumer Privacy Act (CCPA). This section describes
            your CCPA rights and explains how to exercise those rights.
          </p>
          <p>Under the CCPA, you have the following rights:</p>
          <ul>
            <li>
              The right to know about the personal information we collect about you and how it is
              used and shared
            </li>
            <li>
      ...
      <p>
        ...
        note that we transfer the data to the United States and process it there. Your consent to
