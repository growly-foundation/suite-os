...
INSERT INTO admin_organizations (admin_id, organization_id) VALUES
  ('a1b2c3d4-e5f6-4a7b-8c9d-0e1f2a3b4c5d', 'b3b1a8e2-1c2d-4e5f-8a7b-1a2b3c4d5e6f'),
  ('b2c3d4e5-f6a7-4b8c-9d0e-1f2a3b4c5d6e', 'c4d2b1e3-2f3a-4b5c-9d8e-2b3c4d5e6f7a');

-- Seed for agents
INSERT INTO agents (id, name, description, model, organization_id, resources, status, created_at) VALUES
  ('f6a7b8c9-d0e1-4f2a-3b4c-5d6e7f8a9b0c', 'Agent Smith', 'Handles support', 'gpt-4', 'b3b1a8e2-1c2d-4e5f-8a7b-1a2b3c4d5e6f', ARRAY['resource-1'], 'active', NOW()),
  ('a7b8c9d0-e1f2-4a3b-4c5d-6e7f8a9b0c1d', 'Agent Jones', 'Handles sales', 'gpt-3.5', 'c4d2b1e3-2f3a-4b5c-9d8e-2b3c4d5e6f7a', ARRAY['resource-2'], 'inactive', NOW());
