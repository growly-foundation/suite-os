...
export function makePortfolioAnalyzerTool(configService: ConfigService) {
  ...
  return new DynamicStructuredTool({
    ...
    description: `
Performs a detailed analysis of a crypto portfolio and provides personalized rebalancing suggestions.
...
- strategy: Rebalancing strategy preference ("conservative", "moderate", or "aggressive")

Output:
- A detailed portfolio analysis with personalized rebalancing suggestions
`,
    schema: z
      .object({
