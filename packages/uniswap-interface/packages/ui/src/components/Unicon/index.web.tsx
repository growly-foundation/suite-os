...
const UniconSVGBase = (props: UniconProps): React.ReactElement | null =>
  UniconSVGInner({ ...props, icons: Icons });
...
const UniconSVGComponent = isTestEnv
  ...
  : lazy(async () => {
      ...
      return {
        default: (props: UniconProps): React.ReactElement | null =>
          UniconSVGInner({ ...props, icons: LazyIcons }),
      };
    });
