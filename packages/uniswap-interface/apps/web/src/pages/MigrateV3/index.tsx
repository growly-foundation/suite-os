...
import {
  ...
  useMigrateV3TxContext,
} from 'pages/MigrateV3/MigrateV3LiquidityTxContext';
          ...
          <Flex
            ...
            onPress={() => {
              setPositionState({
                ...
                protocolVersion,
                currencyInputs: {
                  [PositionField.TOKEN0]: getCurrencyForProtocol(
                    currency0Amount.currency,
                    protocolVersion
                  ),
                  [PositionField.TOKEN1]: getCurrencyForProtocol(
          ...
          {!media.xl && (
            <Flex
              ...
              <PoolProgressIndicator
                steps={[
                  {
                    label: t('migrate.selectFeeTier'),
                    active: step === PositionFlowStep.SELECT_TOKENS_AND_FEE_TIER,
                  },
      ...
      <Modal
        ...
        <Flex gap="$gap16" px="$padding16" my="$spacing8">
          <TokenInfo
            ...
            currencyUSDAmount={currency0FiatAmount}
            isMigrating
          />
          ...
          <TokenInfo
            ...
            currencyUSDAmount={currency1FiatAmount}
            isMigrating
          />
        </Flex>
