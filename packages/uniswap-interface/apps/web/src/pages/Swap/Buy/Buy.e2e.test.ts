...
test.describe('Buy Crypto Form', () => {
  test.beforeEach(async ({ page }) => {
    const mockRoutes = [
      ...
      {
        pattern: '**/fiat-on-ramp/supported-fiat-currencies*',
        file: Mocks.FiatOnRamp.supported_fiat_currencies,
      },
      {
        pattern: '**/fiat-on-ramp/supported-countries*',
        file: Mocks.FiatOnRamp.supported_countries,
      },
