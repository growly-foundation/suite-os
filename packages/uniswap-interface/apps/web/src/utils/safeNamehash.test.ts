...
describe('safeNamehash', () => {
  ...
  it('namehash works on text', () => {
    expect(namehash(textname)).toEqual(
      '0xdf9f9b4fcb3ade7e9511f102ef22522bdd82ea57c5e03ce4acb63f1bf78befc6'
    );
  });

  it('namehash works on emoji', () => {
    expect(namehash(emoji)).toEqual(
      '0x2d241026bcc4bd7e3be134b85d4a4e2baa61e1a682492f40361ba92aee2bf82e'
    );
  });
