...
describe('formatNumber', () => {
  ...
  it('formats token reference numbers correctly with Dutch locale', () => {
    ...
    expect(formatNumber({ input: 1234567000000000, type: NumberType.TokenNonTx })).toBe(
      '>999\xa0bln.'
    );
  ...
  it('formats token transaction numbers correctly with russian locale', () => {
    ...
    expect(formatNumber({ input: 1234567.8901, type: NumberType.TokenTx })).toBe(
      '1\xa0234\xa0567,89'
    );
  ...
  it('formats fiat estimates on token details pages correctly', () => {
    ...
    expect(formatNumber({ input: 0.00001231, type: NumberType.FiatTokenDetails })).toBe(
      '$0.0000123'
    );

    expect(formatNumber({ input: 0.0000001234, type: NumberType.FiatTokenDetails })).toBe(
      '$0.000000123'
    );
    expect(formatNumber({ input: 0.000000009876, type: NumberType.FiatTokenDetails })).toBe(
      '<$0.00000001'
    );
  });
  ...
  it('formats fiat estimates on token details pages correctly with french locale and euro currency', () => {
    ...
    expect(formatNumber({ input: 1234567.891, type: NumberType.FiatTokenDetails })).toBe(
      '1,23\xa0M\xa0€'
    );
    expect(formatNumber({ input: 1234.5678, type: NumberType.FiatTokenDetails })).toBe(
      '1\u202f234,57\xa0€'
    );
    expect(formatNumber({ input: 1.048942, type: NumberType.FiatTokenDetails })).toBe('1,049\xa0€');

    expect(formatNumber({ input: 0.001231, type: NumberType.FiatTokenDetails })).toBe(
      '0,00123\xa0€'
    );
    expect(formatNumber({ input: 0.00001231, type: NumberType.FiatTokenDetails })).toBe(
      '0,0000123\xa0€'
  ...
  it('formats fiat estimates for tokens correctly', () => {
    ...
    expect(formatNumber({ input: 0.0000001234, type: NumberType.FiatTokenPrice })).toBe(
      '$0.000000123'
    );
    expect(formatNumber({ input: 0.000000009876, type: NumberType.FiatTokenPrice })).toBe(
      '<$0.00000001'
    );
    expect(
      formatNumber({ input: 10000000000000000000000000000000, type: NumberType.FiatTokenPrice })
    ).toBe('$1.000000E31');
  });
  ...
  it('formats fiat estimates for tokens correctly with spanish locale and yen currency', () => {
    ...
    expect(formatNumber({ input: 1234567.891, type: NumberType.FiatTokenPrice })).toBe(
      '1,23\xa0M¥'
    );
    expect(formatNumber({ input: 1234.5678, type: NumberType.FiatTokenPrice })).toBe(
      '1234,57\xa0¥'
    );
    expect(formatNumber({ input: 12345.678, type: NumberType.FiatTokenPrice })).toBe(
      '12.345,68\xa0¥'
    );
    ...
    expect(formatNumber({ input: 0.00001231, type: NumberType.FiatTokenPrice })).toBe(
      '0,0000123\xa0¥'
    );
  ...
  it('formats gas prices correctly with portugese locale and thai baht currency', () => {
    ...
    expect(formatNumber({ input: 1234567.891, type: NumberType.FiatGasPrice })).toBe(
      '฿\xa01,23\xa0mi'
    );
  ...
  it('formats Swap text input/output numbers correctly', () => {
    ...
    expect(formatNumber({ input: 0.000000001, type: NumberType.SwapTradeAmount })).toBe(
      '0.000000001'
    );
  ...
  it('formats NFT numbers correctly', () => {
    ...
    expect(formatNumber({ input: 1234567000000000, type: NumberType.NFTTokenFloorPrice })).toBe(
      '>999T'
    );
    ...
    expect(formatNumber({ input: 12.1, type: NumberType.NFTTokenFloorPriceTrailingZeros })).toBe(
      '12.10'
    );
    expect(formatNumber({ input: 0.09001, type: NumberType.NFTTokenFloorPriceTrailingZeros })).toBe(
      '0.090'
    );
    ...
    expect(formatNumber({ input: 1234567000000000, type: NumberType.NFTCollectionStats })).toBe(
      '1234.6T'
    );
  });
  ...
  it('formats NFT numbers correctly with brazilian portuguese locale and brazilian real currency', () => {
    ...
    expect(formatNumber({ input: 0.987654321, type: NumberType.NFTCollectionStats })).toBe('1');
    expect(formatNumber({ input: 0.9, type: NumberType.NFTCollectionStats })).toBe('1');
    expect(formatNumber({ input: 76543.21, type: NumberType.NFTCollectionStats })).toBe(
      '76,5\xa0mil'
    );
    expect(formatNumber({ input: 7.60000054321, type: NumberType.NFTCollectionStats })).toBe('8');
    expect(formatNumber({ input: 1234567890, type: NumberType.NFTCollectionStats })).toBe(
      '1,2\xa0bi'
    );
    expect(formatNumber({ input: 1234567000000000, type: NumberType.NFTCollectionStats })).toBe(
      '1234,6\xa0tri'
