...
describe('largerPercentValue', () => {
  it('should return the larger percent value', () => {
    expect(largerPercentValue(new Percent(100, 1000), new Percent(200, 1000))).toEqual(
      new Percent(200, 1000)
    );
  });
  ...
  it('should return first if both percent values are equal', () => {
    expect(largerPercentValue(new Percent(100, 1000), new Percent(100, 1000))).toEqual(
