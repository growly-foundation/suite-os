...
const LazyIconWrapper = forwardRef<SVGSVGElement, { children: React.ReactElement<SVGProps> }>(
  ({ children }, ref) => (
...
const LazyVerifiedIcon = React.lazy(() =>
  import('./icons').then(module => ({ default: module.VerifiedIcon }))
);
...
const LazyNft20Icon = React.lazy(() =>
  import('./icons').then(module => ({ default: module.Nft20Icon }))
);
const LazyNftXIcon = React.lazy(() =>
  import('./icons').then(module => ({ default: module.NftXIcon }))
);
const LazyX2y2Icon = React.lazy(() =>
  import('./icons').then(module => ({ default: module.X2y2Icon }))
);
const LazySudoSwapIcon = React.lazy(() =>
  import('./icons').then(module => ({ default: module.SudoSwapIcon }))
);
const LazyLooksRareIcon = React.lazy(() =>
  import('./icons').then(module => ({ default: module.LooksRareIcon }))
);
...
export const ReversedArrowsIcon = forwardRef<SVGSVGElement, SVGProps & { size?: string }>(
  (props, ref) => (
    <LazyIconWrapper ref={ref}>
