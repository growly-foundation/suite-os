...
export const ThemedText = {
  ...
  HeadlineSmall(props: TextProps) {
    return (
      <TextWrapper fontWeight={485} fontSize={20} lineHeight="28px" color="neutral1" {...props} />
    );
  },
  ...
  HeadlineLarge(props: TextProps) {
    return (
      <TextWrapper fontWeight={485} fontSize={36} lineHeight="44px" color="neutral1" {...props} />
    );
  },
  ...
  Caption(props: TextProps) {
    return (
      <TextWrapper fontWeight={485} fontSize={12} lineHeight="16px" color="neutral1" {...props} />
    );
  },
  ...
  SubHeader(props: TextProps) {
    return (
      <TextWrapper fontWeight={485} fontSize={16} color="neutral1" lineHeight="24px" {...props} />
    );
  },
