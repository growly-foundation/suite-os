...
export const selectNeedsToCheckCapabilities = (state: {
...
const selectWalletCapabilitiesSupported = (state: {
  walletCapabilities: WalletCapabilitiesState;
}): boolean => {
  return state.walletCapabilities.getCapabilitiesStatus === GetCapabilitiesStatus.Supported;
};

export const selectIsAtomicBatchingSupported = (state: {
  walletCapabilities: WalletCapabilitiesState;
}): boolean => {
...
export const selectIsAtomicBatchingSupportedByChainId = (state: {
  ...
  return (chainId: number) => {
    ...
    const atomicBatchingSupported = isAtomicBatchingSupportedByChainId(
      state.walletCapabilities.byChain,
      chainId
    );
