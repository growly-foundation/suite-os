...
const createUniverseSwapTransaction = (
  ...
  const inputCurrencyId =
    info.inputCurrencyId === 'ETH' ? null : buildCurrencyId(chainId, info.inputCurrencyId);
  const outputCurrencyId =
    info.outputCurrencyId === 'ETH' ? null : buildCurrencyId(chainId, info.outputCurrencyId);
...
const createUniverseBridgeTransaction = (
  ...
  const inputCurrencyId =
    info.inputCurrencyId === 'ETH' ? null : buildCurrencyId(inputChainId, info.inputCurrencyId);
  const outputCurrencyId =
