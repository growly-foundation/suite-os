...
export function PoolDetailsStatsButtons({
  ...
  const position =
    userOwnedPositions && findMatchingPosition(userOwnedPositions, token0, token1, feeTier);
    ...
    <Flex flexDirection="column" gap="$gap24">
      <PoolButtonsWrapper isMobile={isMobile}>
        <Flex
          ...
          gap={screenSizeLargerThanTablet ? '$spacing12' : '$spacing8'}
          width="100%">
          <PoolButton
      ...
      <SwapModalWrapper open={swapModalOpen} data-testid="pool-details-swap-modal">
        ...
        <TokenWarningCard
          ...
          onPress={() => onWarningCardCtaPressed(currencyInfo0)}
        />
        <TokenWarningCard
          currencyInfo={currencyInfo1}
          onPress={() => onWarningCardCtaPressed(currencyInfo1)}
        />
