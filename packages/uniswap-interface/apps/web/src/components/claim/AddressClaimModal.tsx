        ...
        <Flex gap="$gap12" width="100%">
          ...
          <AutoColumn gap="md" style={{ padding: '1rem', paddingTop: '0' }} justify="center">
            <Text variant="subheading1" color="$white">
              Enter an address to trigger a UNI claim. If the address has any claimable UNI it will
              be sent to them on submission.
            </Text>
            <AddressInputPanel value={typed} onChange={handleRecipientType} />
            {parsedAddress && !hasAvailableClaim && (
              <Text color="$statusCritical">Address has no available claim</Text>
            )}
            <Flex row>
              <Button
                variant="branded"
