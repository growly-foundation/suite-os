...
export default function ClaimPopup() {
  ...
  const { isOpen: claimPopupIsOpen, toggleModal: toggleClaimPopup } = useModalState(
    ModalName.ClaimPopup
  );

  // toggle for showing this modal
  const { isOpen: showClaimModal, toggleModal: toggleClaimModal } = useModalState(
  ...
  const unclaimedAmount: CurrencyAmount<Token> | undefined = useUserUnclaimedAmount(
    account.address
  );
