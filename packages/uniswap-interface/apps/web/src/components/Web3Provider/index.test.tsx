...
const account1Result = { address: ACCOUNT1, connector: { name: 'test' } } as unknown as ReturnType<
  typeof useAccount
>;
const account2Result = { address: ACCOUNT2, connector: { name: 'test' } } as unknown as ReturnType<
  typeof useAccount
>;
