...
export function LiquidityPositionInfo({
  ...
  const { currency0Amount, currency1Amount, status, feeTier, v4hook, version, chainId } =
    positionInfo;
  ...
  return (
    <Flex
      ...
      gap="$gap16"
      $md={{ width: '100%' }}
      alignItems={isMiniVersion ? 'center' : 'flex-start'}>
      <SplitLogo
            ...
            {includeLpIncentives && lpIncentiveRewardApr && (
              <LpIncentivesAprDisplay
                ...
                tooltipProps={{
                  ...
                  totalApr:
                    positionInfo.version === ProtocolVersion.V4 ? positionInfo.totalApr : undefined,
                }}
              />
            )}
          </Flex>
