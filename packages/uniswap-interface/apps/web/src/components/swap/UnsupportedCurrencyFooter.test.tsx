  ...
  it('works as expected when one unsupported token exists', async () => {
    ...
    expect(
      screen.getByText(content =>
        content.startsWith('Some assets are not available through this interface')
      )
    ).toBeInTheDocument();
    ...
    expect(
      within(unsupportedCard).getByText(shortenAddress(unsupportedTokenAddress)).closest('a')
