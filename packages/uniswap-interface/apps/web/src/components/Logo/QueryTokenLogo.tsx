...
export default function QueryTokenLogo(
  ...
  const chainId =
    getChainIdFromChainUrlParam(props.token?.chain.toLowerCase()) ?? UniverseChainId.Mainnet;
  ...
  const logoUrl =
    !!props.token && 'id' in props.token ? props.token?.project?.logoUrl : props.token?.logo;
