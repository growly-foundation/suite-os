...
import {
  useOpenLimitOrders,
  usePendingActivity,
} from 'components/AccountDrawer/MiniPortfolio/Activity/hooks';
import { useAccountDrawer } from 'components/AccountDrawer/MiniPortfolio/hooks';
import { Pool } from 'components/Icons/Pool';
import {
  ExtensionRequestMethods,
  useUniswapExtensionConnector,
} from 'components/WalletModal/useOrderedConnections';
  ...
  return (
    <Flex gap="$spacing8">
      <DeepLinkButton
        ...
        onPress={() => {
          uniswapExtensionConnector.extensionRequest(
            ExtensionRequestMethods.OPEN_SIDEBAR,
            'Tokens'
          );
          accountDrawer.close();
        }}
