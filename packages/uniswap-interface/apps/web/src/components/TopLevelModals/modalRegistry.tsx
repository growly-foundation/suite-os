...
const UkDisclaimerModal = lazy(() =>
  import('components/TopLevelModals/UkDisclaimerModal').then(module => ({
    default: module.UkDisclaimerModal,
  }))
);
const TestnetModeModal = lazy(() =>
  import('uniswap/src/features/testnets/TestnetModeModal').then(module => ({
    default: module.TestnetModeModal,
  }))
);
...
const RemoveLiquidityModal = lazy(() =>
  import('pages/RemoveLiquidity/RemoveLiquidityModal').then(module => ({
    default: module.RemoveLiquidityModal,
  }))
);
...
const RecoveryPhraseModal = lazy(() =>
  import('components/RecoveryPhrase/Modal').then(module => ({
    default: module.RecoveryPhraseModal,
  }))
);
const PasskeysHelpModal = lazy(() =>
  import('uniswap/src/features/passkey/PasskeysHelpModal').then(module => ({
    default: module.PasskeysHelpModal,
  }))
);
...
export const ModalRenderer = ({
  ...
  return (
    <ModalWrapper Component={Component} componentProps={{ ...componentProps, ...modalState }} />
  );
};
