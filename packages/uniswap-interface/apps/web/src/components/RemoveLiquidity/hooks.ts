...
export function useRemoveLiquidityTxAndGasInfo({
  account,
}: {
  account?: string;
  ...
  const totalGasFeeEstimate = v2ApprovalGasFeeUSD
    ? decreaseGasFeeUsd?.add(v2ApprovalGasFeeUSD)
    : decreaseGasFeeUsd;
