...
describe('Legacy Pool Redirects', () => {
  ...
  it('should redirect remove v2 liquidity to positions page', () => {
    cy.visit(
      '/remove/v2/0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599/0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2'
    );
    cy.url().should(
      'match',
      /\/positions\/v2\/ethereum\/0xBb2b8038a1640196FbE3e38816F3e67Cba72D940/
    );
  });
