...
function CheckTable(props: { tableData: any }) {
  ...
  const columns = [
    ...
    columnHelper.accessor('email', {
      id: 'email',
      header: () => (
        <p className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">EMAIL ADDRESS</p>
      ),
      cell: info => (
    ...
    columnHelper.accessor('provider', {
      id: 'provider',
      header: () => (
        <p className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">PROVIDER</p>
      ),
      cell: (info: any) => (
    ...
    columnHelper.accessor('created', {
      id: 'created',
      header: () => (
        <p className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">CREATED</p>
      ),
      cell: (info: any) => (
        <div className="flex w-full items-center gap-[14px]">
          <p className="text-sm font-medium text-zinc-950 dark:text-white">{info.getValue()}</p>
    ...
    columnHelper.accessor('lastsigned', {
      id: 'lastsigned',
      header: () => (
        <p className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">LAST SIGN IN</p>
      ),
      cell: info => (
        <p className="text-sm font-medium text-zinc-950 dark:text-white">{info.getValue()}</p>
      ),
    ...
    columnHelper.accessor('uuid', {
      id: 'uuid',
      header: () => (
        <p className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">USER UID</p>
      ),
      cell: info => (
        <p className="text-sm font-medium text-zinc-950 dark:text-white">{info.getValue()}</p>
      ),
    ...
    columnHelper.accessor('menu', {
      id: 'menu',
      header: () => <p className="text-xs font-semibold text-zinc-500 dark:text-zinc-400"></p>,
