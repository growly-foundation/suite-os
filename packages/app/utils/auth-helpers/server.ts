...
export async function signUp(formData: FormData) {
  ...
  if (error) {
    redirectPath = getErrorRedirect('/dashboard/signin/signup', 'Sign up failed.', error.message);
...
export async function updateEmail(formData: FormData) {
  ...
  const callbackUrl = getURL(
    getStatusRedirect('/dashboard/settings', 'Success!', `Your email has been updated.`)
  );
...
export async function updateName(formData: FormData) {
  ...
  if (error) {
    ...
    return getStatusRedirect('/dashboard/settings', 'Success!', 'Your name has been updated.');
  } else {
    return getErrorRedirect(
      '/dashboard/settings',
      'Hmm... Something went wrong.',
