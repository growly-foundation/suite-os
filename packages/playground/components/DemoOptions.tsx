...
const COMMON_OPTIONS = [ActiveComponent, ComponentMode, ComponentTheme, WalletType];

const COMPONENT_CONFIG: Partial<Record<OnchainKitComponent, (() => React.JSX.Element)[]>> = {
  [OnchainKitComponent.Buy]: [Chain, PaymasterUrl, IsSponsored, SwapConfig],
  [OnchainKitComponent.Checkout]: [Chain, PaymasterUrl, IsSponsored, CheckoutOptions],
  [OnchainKitComponent.Swap]: [Chain, PaymasterUrl, IsSponsored, SwapConfig],
  [OnchainKitComponent.SwapDefault]: [Chain, PaymasterUrl, IsSponsored, SwapConfig],
  [OnchainKitComponent.Transaction]: [Chain, PaymasterUrl, IsSponsored, TransactionOptions],
  [OnchainKitComponent.TransactionDefault]: [Chain, PaymasterUrl, IsSponsored, TransactionOptions],
  [OnchainKitComponent.NFTCard]: [Chain, NFTOptions],
  [OnchainKitComponent.NFTCardDefault]: [Chain, NFTOptions],
  [OnchainKitComponent.NFTMintCard]: [Chain, PaymasterUrl, IsSponsored, NFTOptions],
  [OnchainKitComponent.NFTMintCardDefault]: [Chain, PaymasterUrl, IsSponsored, NFTOptions],
  [OnchainKitComponent.Earn]: [EarnOptions],
  [OnchainKitComponent.Signature]: [Chain],
};

export default function DemoOptions({ component }: { component?: OnchainKitComponent }) {
