...
const getConnector = (walletType: WalletPreference, connectors: GetConnectorsReturnType) => {
  ...
  return (
    <div className="grid gap-2">
      ...
      <RadioGroup
        ...
        <button type="button" className="text-xs hover:underline" onClick={disconnectAll}>
          Disconnect all
        </button>
      </RadioGroup>
