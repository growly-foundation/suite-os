...
import { OnchainKitComponent } from '@/types/appstack';
  ...
  return (
    <div className="grid gap-2">
      ...
      <Select
        ...
        <SelectContent>
          <SelectItem value={OnchainKitComponent.FundButton}>Fund Button</SelectItem>
          <SelectItem value={OnchainKitComponent.FundCard}>Fund Card</SelectItem>
          <SelectItem value={OnchainKitComponent.Buy}>Buy</SelectItem>
          <SelectItem value={OnchainKitComponent.Identity}>Identity</SelectItem>
          <SelectItem value={OnchainKitComponent.IdentityCard}>IdentityCard</SelectItem>
          ...
          <SelectItem value={OnchainKitComponent.TransactionDefault}>TransactionDefault</SelectItem>
          <SelectItem value={OnchainKitComponent.Swap}>Swap</SelectItem>
          <SelectItem value={OnchainKitComponent.SwapDefault}>SwapDefault</SelectItem>
          <SelectItem value={OnchainKitComponent.Wallet}>Wallet</SelectItem>
          <SelectItem value={OnchainKitComponent.WalletDefault}>WalletDefault</SelectItem>
          <SelectItem value={OnchainKitComponent.WalletAdvancedDefault}>
            WalletAdvancedDefault
          </SelectItem>
          <SelectItem value={OnchainKitComponent.WalletIsland}>WalletIsland</SelectItem>
          <SelectItem value={OnchainKitComponent.NFTCard}>NFT Card</SelectItem>
          <SelectItem value={OnchainKitComponent.NFTCardDefault}>NFT Card Default</SelectItem>
          <SelectItem value={OnchainKitComponent.NFTMintCard}>NFT Mint Card</SelectItem>
          ...
          <SelectItem value={OnchainKitComponent.Signature}>Signature</SelectItem>
        </SelectContent>
      </Select>
    </div>
  );
